...
export function Slide2Axioms({ slideNumber, totalSlides }: Slide2Props) {
  const axioms = [
    {
      ...
      description: 'Протон — Kerr-Newman ЧД (Burinskii), масса подавлена RS-warping (Randall-Sundrum)',
      color: 'text-blue-400'
    },
    {
      icon: Shield,
      title: 'Стабильность',
      description: 'Замедление времени на эффективном горизонте (замороженная звезда). Заряд — топологический инвариант браны',
      color: 'text-green-400'
    },
    {
      icon: Zap,
      title: 'Сильное взаимодействие',
      description: 'Градиент dn/dr → конфайнмент (оптическая аналогия). Резкое изменение показателя преломления вакуума',
      color: 'text-purple-400'
    },
    {
      icon: Orbit,
      title: 'Тёмная энергия',
      description: 'Энтропийное натяжение браны, evolving Λ_eff (подтверждено DESI 2025)',
  ...
  return (
    <Slide
      title="Ключевые аксиомы и решенные парадоксы"
      subtitle="Четыре фундаментальных принципа SIFS"
    ...
    >
      <div className="space-y-6">
        ...
        <div className="p-6 bg-gradient-to-r from-blue-950/50 to-purple-950/50 border border-blue-500/30 rounded-lg max-w-6xl">
          <h3 className="mb-3 text-cyan-400 text-center">Braneworld RS2</h3>
          <p className="text-gray-300 text-center leading-relaxed">
            Наша 4D-вселенная локализована на бране в 5-мерном Anti-de Sitter пространстве. 
            Экспоненциальное warping метрики exp(−k|S|) естественно объясняет иерархию масс 
            между планковским и электрослабым масштабами.
          </p>
        </div>
