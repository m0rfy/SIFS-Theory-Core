...
const freeApplications: ApplicationData[] = [
  {
...
const fundedApplications: ApplicationData[] = [
  {
...
function ApplicationItem({ app, variant }: ApplicationItemProps) {
  ...
  return (
    <div className={cn(
      ...
      isGreen 
        ? "bg-green-900/10 border-green-500/10 hover:bg-green-900/20" 
        : "bg-purple-900/10 border-purple-500/10 hover:bg-purple-900/20"
    )}>
      <div className={cn(
        "mt-1 p-2 rounded-md transition-colors shrink-0",
        isGreen 
          ? "bg-green-500/10 text-green-400 group-hover:text-green-300" 
            ...
            <ScrollArea className="h-full max-h-[600px] p-4">
              <div className="space-y-3">
                {freeApplications.map((app) => (
                  <ApplicationItem key={app.title} app={app} variant="green" />
                ))}
              </div>
            </ScrollArea>
          </CardContent>
            ...
            <ScrollArea className="h-full max-h-[600px] p-4">
              <div className="space-y-3">
                {fundedApplications.map((app) => (
                  <ApplicationItem key={app.title} app={app} variant="purple" />
                ))}
              </div>
            </ScrollArea>
          </CardContent>
