...
![Маршрут изготовления](../images/hardware/sifs_fabrication.png)
*Технологический маршрут: e-beam → ALD → Au → Si₃N₄ → QD → тест*

![Тест антенного элемента](../images/hardware/sifs_antenna_test.png)
*Тест антенного элемента для плазмонного слоя*

![Виды процессора](../images/hardware/sifs_views.png)
*Различные проекции SIFS Processor*

![3D топология](../images/hardware/sifs_topology_3d.png)
